  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.shangjiatupian" label="商家图片" prop="shangjiatupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shangjiatupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="是否会员" prop="vip">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shangjiajieshao = this.ruleForm.shangjiajieshao.replace(reg,'../../../ssm6f5y5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
