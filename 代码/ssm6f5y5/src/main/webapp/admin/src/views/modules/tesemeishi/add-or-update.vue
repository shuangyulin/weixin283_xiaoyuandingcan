<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="特色" prop="tese">
          <el-input v-model="ruleForm.tese" 
              placeholder="特色" clearable  :readonly="ro.tese"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="特色" prop="tese">
              <el-input v-model="ruleForm.tese" 
...
export default {
  ...
  methods: {
	...
	this.ruleForm.meishixiangqing = this.ruleForm.meishixiangqing.replace(reg,'../../../ssm6f5y5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
