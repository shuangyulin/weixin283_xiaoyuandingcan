      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.shangjiadizhi" class="input" type="text" placeholder="商家地址">
			   </div>
			 </div> -->
			<el-form-item label="商家地址" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.shangjiadizhi" autocomplete="off" placeholder="商家地址"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			...
			<el-form-item label="联系人" class="input" v-if="tableName=='shangjia'">
			...
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.jingyingfanwei" class="input" type="text" placeholder="经营范围">
			   </div>
			 </div> -->
			<el-form-item label="经营范围" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.jingyingfanwei" autocomplete="off" placeholder="经营范围"  />
			</el-form-item>
